...
sudo pacman -S sddm bspwm sxhkd kitty rofi polybar picom thunar nitrogen
yay -S lxpolkit
# Installing Other less important Programs
sudo pacman -S gimp vim lxappearance
# Installing Custom ocs-url package
#dnf install ./rpm-packages/ocs-url-3.1.0-1.fc20.x86_64.rpm

# Installing fonts
sudo pacman -S ttf-font-awesome papirus-icon-theme noto-fonts-emoji
